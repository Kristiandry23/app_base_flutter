...
import 'package:notifikasi/Shared/svg_list/maintenance.dart';
import 'package:notifikasi/Shared/svg_list/noData.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              ErrorInfo(
                title: "Access denied",
                description: "Please check your connection or your wifi connection",
                btnText: "Retry",
                press: () async {
                  bool isConnected = await Constants.checkConnection();
