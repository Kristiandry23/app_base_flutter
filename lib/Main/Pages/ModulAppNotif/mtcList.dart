...
class MtcListPage extends StatelessWidget {
  const MtcListPage({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Consumer<MtcListController>(
      builder: (context, listController, child) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final MtcModel item = items[index];
            return Card(
